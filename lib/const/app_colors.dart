...
class AppColors {
  ...
  static final Color backGroundColor = Color(0xffE6E6E6);
  static final Color buttonBackGround = Color(0xfF0DB295);
  ...
  static const Color listTileBackgroundColor = Color.fromARGB(
    255,
    132,
    197,
    186,
